---
name: save-context
description: Saves a decision, fix, feature, or discovery to persistent memory via context.save. Use whenever the user says "save this" / "remember this", or right after finishing a task.
---
...
- Immediately after finishing a task, fix, or non-obvious discovery
- The user says "save this" / "remember this" / "compact now"
